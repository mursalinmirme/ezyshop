            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-borderd table-striped">
                  ...
                  <tbody>
                  <?php $products = getallproduct("products");
                  if(mysqli_num_rows($products) > 0){
                    while($row = mysqli_fetch_assoc($products)){ ?>
                      <tr class="redesigncate">
                      <td class="text-center pt-3"><?php echo $row['id'] ?></td>
                      <td class="text-center pt-3"><?php echo $row['name'] ?></td>
                      <td class="text-center"><img src="../upload/<?php echo $row['image']?>" width="50px" height="50px" alt=""></td>
                      <td class="text-center pt-3"><?php echo $row['status']?"visible":"hidden" ?></td>
